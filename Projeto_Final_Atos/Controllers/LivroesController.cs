...
namespace Projeto_Final_Atos.Controllers
{
    public class LivroesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,Editora,Idioma,Autor,capa,FotoLivro,Resenha")] Livro livro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,Editora,Idioma,Autor,capa,FotoLivro,Resenha")] Livro livro)
        {
            if (id != livro.Id)
            {
                return NotFound();
